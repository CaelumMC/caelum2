package io.github.caelummc.uplands.datagen;

import io.github.caelummc.uplands.Uplands;
...
class ModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator gen) {
        ...
        gen.registerParentedItemModel(Uplands.Blocks.AERRACK, new Identifier("uplands:block/aerrack"));
        gen.registerParentedItemModel(Uplands.Blocks.AERRACK_GRAVEL, new Identifier("uplands:block/aerrack_gravel"));
        gen.registerParentedItemModel(Uplands.Blocks.ROOTED_AERRACK, new Identifier("uplands:block/rooted_aerrack"));
        gen.registerParentedItemModel(Uplands.Blocks.MOSSY_AERRACK, new Identifier("uplands:block/mossy_aerrack"));
        gen.registerParentedItemModel(Uplands.Blocks.SKYMOSS_BLOCK, new Identifier("uplands:block/skymoss_block"));
